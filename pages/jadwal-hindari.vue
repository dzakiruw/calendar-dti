...
// Data Form
const form = ref({ agenda: '', sesi: 'sesi 1', hari: 'Senin' });
...
const submitForm = () => {
  if (editIndex.value !== null) {
    // Edit Data
    jadwalList.value[editIndex.value] = { ...form.value };
    editIndex.value = null;
  } else {
    // Tambah Data Baru
    jadwalList.value.push({ ...form.value });
  }

  // Reset Form
  form.value = { agenda: '', sesi: 'sesi 1', hari: 'Senin' };
};
