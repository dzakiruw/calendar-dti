<template>
  ...
  >
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-3">
              <div class="grid grid-cols-3 gap-4">
                ...
                >
                  ...
                  />
                  <div
                    class="p-3 text-center rounded-xl border border-gray-200 cursor-pointer transition-all duration-300"
                    :class="{
                      'bg-green-50 border-green-500 text-green-600':
                        form.hindari_hari === hari,
      ...
      <div
        class="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg border border-gray-100 flex flex-col"
      >
        ...
        >
          ...
          <p class="text-center">
            {{
              searchQuery
                ? "Tidak ditemukan jadwal hindari yang sesuai."
                ...
                <div>
                  ...
                  <div class="space-y-2">
                    <div class="flex items-center gap-3">
                      <span
                        class="inline-flex items-center gap-2 px-3 py-1 bg-blue-100 text-blue-600 rounded-lg text-sm font-medium"
                      >
                        <i class="fas fa-calendar-day"></i>
                        {{ jadwal.hindari_hari }}
                      </span>
                      <span
                        class="inline-flex items-center gap-2 px-3 py-1 bg-indigo-100 text-indigo-600 rounded-lg text-sm font-medium"
                      >
...
const filteredJadwalHindariList = computed(() => {
  ...
  return jadwalList.value.filter(
    (jadwal) =>
...
const fetchJadwal = async () => {
  try {
    ...
    const response = await axios.get("http://localhost:5000/jadwal_hindari", {
      headers: {
  ...
  try {
    ...
    if (editIndex.value !== null) {
      ...
      response = await axios.patch(
        `http://localhost:5000/jadwal_hindari/${jadwalId}`,
        newJadwal,
        { headers }
      );
...
const deleteJadwal = async (index) => {
  ...
  try {
    ...
    await axios.delete(`http://localhost:5000/jadwal_hindari/${jadwalId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
      },
...
const editJadwalHindari = (index) => {
  ...
  selectedIndex.value = jadwalList.value.findIndex(
    (j) => j.id_hindari === jadwal.id_hindari
  );
...
const confirmEdit = () => {
  ...
  form.value.hindari_sesi =
    reverseSesiMap[jadwalHindari.hindari_sesi] || jadwalHindari.hindari_sesi;
...
const confirmDelete = async () => {
  try {
    ...
    await axios.delete(
      `http://localhost:5000/jadwal_hindari/${jadwalHindari.id_hindari}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
